...
public class T03_calender_연산 {
	...
	public static void main(String[] args) {
		...
		System.out.println("오늘부터 100일 후 : " + (date2.get(Calendar.MONTH) + 1) +"월 "+ date2.get(Calendar.DATE)+ "일");
		
		Calendar date3 = Calendar.getInstance();
		date3.add(Calendar.MONTH, 2);
		System.out.println("오늘부터 2달 후 : " + (date3.get(Calendar.MONTH) + 1) +"월 "+ date2.get(Calendar.DATE)+ "일");
