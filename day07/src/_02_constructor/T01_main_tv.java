...
public class T01_main_tv {
	...
	*/
	...
	System.out.println("tv1의 회사 : " + tv4.company);*/
		
	T01_api_tv tv5 = new T01_api_tv("삼성", "FULL HD", 70);
	System.out.println("tv5 : " + tv5.company + ", " + tv5.model + ", " + tv5.channel);
	
	T01_api_tv tv6 = new T01_api_tv("울트라", "LG", 65);
	System.out.println("tv6 : " + tv6.company + ", " + tv6.model + ", " + tv6.channel);	
